 ...
 * @return
 * 		On success, the number of characters written (excluding the null terminator) is returned.
 *   	On error, -1 is returned.
 */
...
/**
 * @brief Prints the hexadecimal representation of an unsigned long 'c' as a pointer.
 *
 * This function prints the hexadecimal representation of 'c' as a pointer, including
 * the "0x" prefix. If 'c' is zero, it prints "(nil)".
 *
 * @param c The unsigned long integer to print as a pointer
 * @return The total number of characters printed, including the "0x" prefix or "(nil)"
 */
 ...
 *
 * This functions accepts a format string and variable arguments, similar to printf,
 * and processes it, printing the formatted text to the standard output.
