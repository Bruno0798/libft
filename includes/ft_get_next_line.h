...
/*   Updated: 2023/10/07 11:30:59 by bsousa-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Reads data from a file descriptor 'fd' and joins it with the 'temp' buffer.
 *
 ...
 * @return The new 'temp' string, or NULL if 'temp' is empty or doesn't contain a newline character
 */
 ...
 * @return The extracted line as a new string, or NULL on memory allocation failure
 */
 ...
 * @return A pointer to the first occurrence of 'fetch', or NULL if not found or 'str' is NULL
 */
